...
```{r}
par(mfrow = c(1,1))
plot(Data1$PropDays~Data1$Year, type = "l", col = "tomato2", lwd = 2)
abline(mod.sen$coefficients[2]*Data1$Year + mod.sen$coefficients[1]) #sen estimator
abline(model1s) #mblm
abline(mod.1, lty = 2, col = "limegreen") #linear model
