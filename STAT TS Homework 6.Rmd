...
The data refer only to the Bozeman area, and to a specific period of years measured between 1900 and 2008. We did not randomly choose the site, nor did we randomly select the time period used to observe the climate there. In fact, since this is a purely observational study we can neither make causal inference nor Thus, the scope of inference for the above t-test is only for the area of Bozeman during the 108 year period specified. To use this result on future (or past) years, or for a different site, would be an unjustified extrapolation. 
